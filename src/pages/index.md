...
{% quick-link title="Finch overview" icon="presets" href="/" description="How does Finch connect your employment system to your application." /%}
...
{% quick-link title="Development best practices" icon="installation" href="/" description="Learn how to integrate Finch into your application properly." /%}

{% quick-link title="Provider specific knowledge" icon="plugins" href="/" description="Focus on supported data fields and troubleshooting for a specific provider." /%}
...
The Finch flow begins when a user (business owner, HR or payroll administrator, etc) wants to connect their employment or payroll provider to your application.

1. Your frontend application redirects your user to Finch Connect, Finch's OAuth 2.0 based authorization flow, which guides your user through granting you access to their employment system.
1. Your front-end receives an authorization code after your user successfully grants your application access.
1. Your front-end sends the short-lived code to your application server, which exchanges it for a long-lived access_token.
1. Your application server saves the access_token, representing your access to your user's system, to read data and push changes.
