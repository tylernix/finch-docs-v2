...
{% figure src="/images/finch-connect-intro.png" alt="diagram of how Finch works" / %}
...
{% figure src="/images/integrating-finch-connect.png" alt="Automated Finch Connect flow" / %}
...
{% figure src="/images/provider-bypass-flow.png" alt="Provider bypass flow" / %}
...
{% figure src="/images/improving-finch-connect-conversion.png" alt="improving finch connect conversion rate" / %}

## Finch Connect in your user's onboarding

If you are integrating Finch into your onboarding flow, we recommend taking the request latencies of the underlying employment systems into consideration while designing the onboarding flow. You can read more about latencies [here](/docs/response-times.md).
