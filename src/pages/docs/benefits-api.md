---
title: Integrating the Benefits API
description: Finch's Benefits API endpoints allow users to read and write benefit deductions (401k, Health Savings Accounts, Loans, etc) across providers using a single, unified API.
---

Finch's [Benefits API](https://developer.tryfinch.com/docs/reference/b3A6MTg4Mzc2MTk-create-benefit) endpoints allow users to read and write benefits deductions (401k, Health Savings Accounts, Loans, etc) across providers using a single, unified API.
