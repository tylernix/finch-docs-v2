...
const navigation = [
  ...
  },
  {
    ...
    links: [
      ...
      {
        title: 'Development Best Practices', children: [
          { title: 'Requesting Permissions', href: '/docs/requesting-permissions' },
  ...
  {
    title: 'Provider Specific Knowledge',
    links: [
      {
        title: 'Gusto', children: [
          { title: 'Reauthentication Flow', href: '/docs/reauthentication-flow' },
          { title: 'Managing Multiple Connections', href: '/docs/managing multiple connections' },
          { title: 'Reconciling Employees', href: '/docs/reconciling employees' },
          { title: 'Batching Requests', href: '/docs/batching-requests' },
      ...
      {
        title: 'Quickbooks Online', children: [
          { title: 'Reauthentication Flow', href: '/docs/reauthentication-flow' },
          { title: 'Managing Multiple Connections', href: '/docs/managing multiple connections' },
          { title: 'Reconciling Employees', href: '/docs/reconciling employees' },
          { title: 'Batching Requests', href: '/docs/batching-requests' },
    ...
    >
      ...
      <div className="relative flex flex-grow basis-0 items-center">
        <Link href="/" aria-label="Home page">
          <Logo className=" h-9 w-auto fill-black dark:fill-white lg:block" />
        </Link>
      </div>
      ...
      <div className="relative flex basis-0 justify-end gap-6 sm:gap-8 md:flex-grow">
        ...
        <Link href="https://github.com/Finch-API/finch-docs" className="group" aria-label="GitHub">
...
export function Layout({ children, title, tableOfContents }) {
  ...
  let isApiReference = router.pathname === '/api-reference'
  ...
  if (isApiReference) {
    return (
      <>
        ...
        <div className="relative mx-auto justify-center sm:px-2 lg:px-8 xl:px-12">
          ...
          <article>
            {(title || section) && (
              <header className="mb-9 space-y-1">
                {section && (
                  <p className="font-display text-sm font-medium text-indigo-600">
                    {section.title}
                  </p>
                )}
                {title && (
