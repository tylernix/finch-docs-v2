...
const code = `
const companyDirectory = await axios({
  method: 'GET',
...
const tabs = [
  { name: 'get-directory.js', isActive: true },
...
export function Hero() {
  return (
    <div className="overflow-hidden bg-[url('https://blog.tryfinch.com/assets/background.svg')] dark:-mb-32 dark:mt-[-4.5rem] dark:pb-32 dark:pt-[4.5rem] dark:lg:mt-[-4.75rem] dark:lg:pt-[4.75rem]">
        ...
        <div className="mx-auto grid max-w-2xl grid-cols-1 items-center gap-y-16 gap-x-8 px-4 lg:max-w-8xl lg:grid-cols-2 lg:px-8 xl:gap-x-16 xl:px-12">
          <div className="relative z-10 md:text-center lg:text-left">
            ...
            <div className="relative">
              <p className="inline text-slate-900 dark:text-white bg-clip-text font-display text-5xl tracking-tight">
          ...
          <div className="relative lg:static xl:pl-10">
            ...
            <div className="relative">
              <div className="absolute inset-0 rounded-2xl bg-slate-900 blur-lg" />
              <div className="absolute inset-0 rounded-2xl bg-slate-900 opacity-10" />
